...
let currentTheme =
	JSON.parse(localStorage.getItem('MovieDBAppDC100')) &&
	JSON.parse(localStorage.getItem('MovieDBAppDC100')).theme
		? JSON.parse(localStorage.getItem('MovieDBAppDC100')).theme
...
const setMainThemeAndMainSpecialColor = () => {
  ...
  localStorage.setItem('MovieDBAppDC100', JSON.stringify(currentThemes[currentThemeIndex]))
};
